    ...
    setActiveLanguage: function( name ) {
      ...
      if ( !LanguageDefinition.isLoadedFor(name) ) {
        ...
        LanguageDefinition.loadFor( name, function(x, t) {
          ...
          Mousetrap.bind(['command+1'], function( e ){ hotkey( e, 'function-h1' ); });
          Mousetrap.bind(['command+2'], function( e ){ hotkey( e, 'function-h2' ); });
          Mousetrap.bind(['command+3'], function( e ){ hotkey( e, 'function-h3' ); });
          Mousetrap.bind(['command+b'], function( e ){ hotkey( e, 'function-bold' ); });
          Mousetrap.bind(['command+i'], function( e ){ hotkey( e, 'function-italic' ); });
